...
def create_realestate_abac_rules():
    ...
    def senior_access(req: AuthorizationRequest) -> bool:
        return (
            ...
            req.action in {"create_listing", "edit_listing", "make_offer", "schedule_showing"}
        )
    ...
    def junior_restriction(req: AuthorizationRequest) -> bool:
        return req.user.attributes.level == 'junior' and req.action in {"make_offer", "schedule_showing"}
...
def create_all_rules():
    ...
    return create_realestate_abac_rules()
