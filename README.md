# Real Estate ABAC Application

Real estate agency with fine-grained ABAC authorization

## Features

- Fine-grained ABAC authorization
- Multiple user roles: Agents, Brokers, Clients, Appraisers, Inspectors
- Resource management: Listings, Offers, Showings, Commissions
